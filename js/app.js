...
function assignValuesToHtmlComponent(obj){
    ...
    document.getElementById('narration').value=obj.hotelName;
...
function addToOCRExpense(){
	...
	if (mydb) {
        ...
        var ocrnarration =  document.getElementById('narration').value;    
      ...
      try{
                 ...
                 mydb.transaction(function (t) {
                    t.executeSql("INSERT INTO ocrExpenseDetails (ocrExpId,accHeadId,expNameId,ocrExpDate,ocrFromLoc,ocrToLoc,ocrnarration,ocrUnit,ocrAmount,currencyId,isEntitlementExceeded,busExpAttachment,wayPointunitValue) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)", 
                        [2,accHeadId,expNameId,'20-05-2018',ocrFromLoc,ocrToLoc,ocrnarration,ocrUnit,ocrAmount,currencyId,isEntitlementExceeded,'null','null']);
                });
        }catch(e){
            alert("e"+e);
        }
...
function checkforDataOCR(){
    ...
    mydb.transaction(function (t) {
        t.executeSql("INSERT INTO ocrExpenseDetails (accHeadId,expNameId,ocrExpDate,ocrFromLoc,ocrToLoc,ocrNarration,ocrUnit,ocrAmount,currencyId,isEntitlementExceeded,busExpAttachment,wayPointunitValue) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)", 
                [1,1,'20-05-2018','asdd','Zxdasd','rgrtrftg',2,1000,1,'Y','null','null']);
    });
    ...
    mydb.transaction(function(t) {
        t.executeSql('SELECT * FROM ocrExpenseDetails;', [],
            ...
            if (result != null && result.rows != null) {
                ...
                for ( neha = 0; neha< result.rows.length; neha++) {   
                    var row = result.rows.item(neha); 
                    ...
                    var data ="<li class='swipeout'> <div class='swipeout-content'> "
                        + " <div class='item-content claimlisting' onclick='expandCollapse(this,"+neha+");'> "
                        ...
                        + " <td>Account head: </td> "
                        + " <td colspan='3'> "
                        + " <input placeholder='Account Head' id = 'accountHeadOcr_"+neha +"' value = "+row.accHeadId+" style='width: 100%;'> "
                        + " </input> "
                        + " </td> "
                        + " </tr> "
                        + " <tr> "
                        + " <td>Expense name: </td> "
                        + " <td> "
                        + " <input id = 'expenseNameOcr_"+neha +"' value = "+row.expNameId+"> "
                        + " </input> "
                        + " </td> "
                        + " <td>Expense date: </td> "
                        + " <td> "
                        + " <input placeholder = 'Expense Date' id = ocrExpDate_"+neha +" value = "+row.ocrExpDate+"> "
                        + " </input> "
                        + " </td> "
                        + " </tr> "
                        + " <tr> "
                        + " <td>From location: </td> "
                        + " <td> "
                        + " <input placeholder = 'From Location' id = ocrFromLoc_"+neha +" value = "+row.ocrFromLoc+"> "
                        + " </input> "
                        + " </td> "
                        + " <td>To location: </td> "
                        + " <td> "
                        + " <input placeholder = 'To Location' id = ocrToLoc_"+neha +" value = "+row.ocrToLoc+"> "
                        + " </input> "
                        + " </td> "
                        + " </tr> "
                        + " <tr> "
                        ...
                        + " <input placeholder = 'Units' id = ocrUnit_"+neha +" value = "+row.ocrUnit+"> "
                        + " </input> "
                        + " </td> "
                        + " <td colspan='2'> "
                        + " <span class='text-left' style='display: block;'>Amount : </span> "
                        + " <input placeholder = 'Amount' id = ocrAmount_"+neha +" value = "+row.ocrAmount+"> "
                        + " </input> "
                        + " </td> "
                        + " <td> "
                        + " <span class='' style='display: block;'>Currency</span> "
                        + " <input id = 'ocrCurrency_"+neha +"' value = "+row.currencyId+"> "
                        + " </input> "
                        + " </td> "
                        + " </tr> "
                        + " <tr> "
                        ...
                        + " <tr> "
                        + " <td colspan='4'> "
                        + " <textarea rows='2' placeholder='Narration' id = ocrNarration_"+neha +">"+row.ocrNarration
                        + " </textarea> "
                        + " </td> "
                        + " </tr> "
                        + " </table> "
                        ...
                        + " <table> "
                        + " <tr> "
                        + " <td><a href='' onclick = updateOcrExpenseDetails();><i class='fa fa-check' aria-hidden='true'></i> Save</a></td> "
                        ...
                        + " <td><a href='' class='closeexpmodal'><i class='fa fa-angle-double-up' aria-hidden='true' onclick='closeAll();'></i> Close</a></td> "
                        + " </tr> "
                        + " </table> "
                        + " </div> "
                        + " </td> "
...
function ocrSelect2(neha1){
    ...
    mydb.transaction(function (t) {
        t.executeSql("SELECT * FROM accountHeadMst", [], function getAccHeadListOcr (transaction, results) {
            ...
            var accHeadOcr = "accountHeadOcr_"+neha1    ;
   ...
   var jsonArr = [];
    if(jsonCurrencyArr != null && jsonCurrencyArr.length > 0){
      ...
      var ocrCurrency = "ocrCurrency_"+neha1    ;
   ...
   var jsonArr = [];
    if(jsonExpArr != null && jsonExpArr.length > 0){
      ...
      var expNameOcr = "expenseNameOcr_"+neha1    ;
   ...
   var ocrExpDate = "ocrExpDate_"+neha1 ;
   console.log(ocrExpDate)
...
function expandCollapse(obj,neha) {
    try {
         jjheader = jj(obj);
        jjcontent = jjheader.next();
        jjheader.hide(obj);
...
function updateOcrExpenseDetails(i,ocrExpId){
       if (mydb) {
        ...
        var accHeadId = document.getElementById('accountHead'+i).value;  
        alert("accHeadId   value " +accHeadId);
        var expNameId = document.getElementById('expenseName'+i).value; 
                alert("expNameId   value " +expNameId);
        var ocrExpDate = document.getElementById('ocrExpDate'+i).value;


        var ocrFromLoc = document.getElementById('ocrFromLoc'+i).value;
        alert("ocrFromLoc   value " +ocrFromLoc);
        var ocrToLoc = document.getElementById('ocrToLoc'+i).value;
        alert("ocrToLoc   value " +ocrToLoc);
        var ocrnarration =  document.getElementById('narration'+i).value;    
        alert("ocrnarration   value " +ocrnarration);
        
        var ocrUnit = document.getElementById('ocrUnit'+i).value;
        alert("ocrUnit   value " +ocrUnit);
        var ocrAmount =  document.getElementById('ocramount'+i).value;
        alert("ocrAmount   value " +ocrAmount);
        var currencyId = document.getElementById('currency'+i).value; 
        alert("currencyId   value " +currencyId);
        var isEntitlementExceeded = "";
        ...
        if (ocrExpId != "") {
           ...
           //  t.executeSql("UPDATE ocrExpenseDetails  set accHeadId = '"accHeadId"',expNameId = '"expNameId"',ocrExpDate = '"ocrExpDate"',ocrFromLoc = '"ocrFromLoc"',ocrToLoc = '"ocrToLoc"',ocrnarration = '"ocrnarration"',ocrUnit = '"ocrUnit"',ocrAmount = '"ocrAmount"',currencyId = '"currencyId"',isEntitlementExceeded = '"isEntitlementExceeded"',busExpAttachment = '"busExpAttachment"',wayPointunitValue = '"wayPointunitValue"' WHERE ocrExpId = "+ocrExpId";");
...
+ " <td><a href=''><i class='fa fa-send' aria-hidden='true' onclick='sendForApprovalForSMS("+i+");'></i> Send Approval</a></td> "
+ " <td><a href=''><i class='fa fa-heart' aria-hidden='true'></i> Add Wishlist</a></td> "
...
function sendForApprovalForSMS(rowid){
